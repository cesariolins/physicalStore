    ...
    async validateCep(cep) {
        try {
            ...
            if (response.data.erro) {
                throw new common_1.HttpException('CEP inválido', common_1.HttpStatus.NOT_FOUND);
            }
            return response.data;
        }
        catch {
            throw new common_1.HttpException('Erro ao validar CEP', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
