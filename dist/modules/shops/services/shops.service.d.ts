...
export declare class ShopsService {
    ...
    constructor(databaseService: DatabaseService, getDistanceService: GetDistanceService, melhorEnvioService: MelhorEnvioService);
    getShopsByCep(cep: string): Promise<Array<Shop & {
        distance: string;
    }> | {
        status: number;
        message: string;
