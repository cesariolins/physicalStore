    ...
    async fetchCoordinates(address) {
        try {
            ...
            if (response.data.length === 0) {
                throw new common_1.HttpException('Não foi possível obter as coordenadas do endereço.', common_1.HttpStatus.NOT_FOUND);
            }
            return {
            ...
            throw new common_1.HttpException('Erro ao tentar obter coordenadas.', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
